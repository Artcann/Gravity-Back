...
export class NotificationController {
  ...
  getNotifications(@Request() req) {
    return this.notificationService.getNotificationByUser(
      req.user.userId,
      req.user.lang,
    );
  }
  ...
  sendNotification(@Body() sendNotificationDto: SendNotificationDto) {
    if (sendNotificationDto.group !== undefined) {
      this.notificationService.sendNotificationToGroup(
        sendNotificationDto.notificationId,
        sendNotificationDto.group,
      );
    }
  }
  ...
  sendNotificationToDevice(
    ...
    return this.notificationService.sendNotificationToDevice(
      notificationId,
      deviceToken,
    );
  }
